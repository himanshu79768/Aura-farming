...
return ( <div className="w-full h-full p-6 flex flex-col justify-between bg-light-card dark:bg-dark-card text-light-card-foreground dark:text-dark-card-foreground"> <div> <h3 className="font-semibold text-left text-base flex items-center gap-2"> <BookOpen size={16} /> Top Subjects </h3> <p className="text-left text-xs text-light-muted-foreground dark:text-dark-muted-foreground">Last 7 days</p> </div>
