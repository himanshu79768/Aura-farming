                    ...
                    <div className="pb-24">
                        ...
                        <div className="mb-6 border-b border-white/10 pb-4">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                {entry.subject && (
                                    <span className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-light-primary/10 dark:bg-dark-primary/10 text-light-primary dark:text-dark-primary border border-light-primary/20 dark:border-dark-primary/20">
                                        {entry.subject}
                                    </span>
                                )}
                            </div>
